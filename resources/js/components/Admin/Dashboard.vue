                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card text-white bg-primary">
                                ...
                                <div class="chart-wrapper mt-3 mx-3" style="height:70px;">
                                    ...
                                    <canvas class="chart chartjs-render-monitor" id="card-chart1" height="105" width="291" style="display: block; height: 70px; width: 194px;"></canvas>
                                    <div id="card-chart1-tooltip" class="chartjs-tooltip top" style="opacity: 0; left: 174.558px; top: 123.889px;">
