...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::get('/admin/booking/{tgl_awal}/{tgl_akhir}', 'API\Reservasi\BookingsController@filterTglBooking');

    Route::get('/admin/notifikasi/dibaca', 'API\KonfigurasiController@readNotification');
